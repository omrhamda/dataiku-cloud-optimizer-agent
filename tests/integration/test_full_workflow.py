...
from dataiku_cloud_optimizer.integrations import DataikuIntegration, DatabricksIntegration
from dataiku_cloud_optimizer.utils.config import load_config, save_config, get_default_config
...
class TestFullWorkflow:
    ...
    def test_configuration_workflow(self):
        ...
        config_data["integrations"]["databricks"]["workspace_url"] = "https://test.databricks.com"
