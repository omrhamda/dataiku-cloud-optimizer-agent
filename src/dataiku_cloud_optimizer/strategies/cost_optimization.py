...
class CostOptimizationStrategy(OptimizationStrategy):
    ...
    def optimize(self, cost_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        logger.info(f"Applying cost optimization strategy to {cost_data.get('provider', 'unknown')} data")
    ...
    def _generate_recommendations(self, cost_data: Dict[str, Any]) -> list:
        ...
        if total_cost > 500:
            ...
            recommendations.append({
                "type": "rightsizing",
                "description": f"Rightsize overprovisioned instances to save ~15% of compute costs",
        ...
        if total_cost > 200:
            unused_savings = min(total_cost * 0.08, 150)  # Up to $150 in unused resources
            recommendations.append({
                "type": "unused_resources",
                "description": f"Remove unused storage volumes, snapshots, and IP addresses",
        ...
        if total_cost > 800:
            ...
            recommendations.append({
                "type": "reservations",
                "description": f"Purchase reserved instances or committed use discounts for consistent workloads",
        ...
        if total_cost > 300:
            ...
            recommendations.append({
                ...
                "description": f"Optimize storage classes and implement lifecycle policies",
